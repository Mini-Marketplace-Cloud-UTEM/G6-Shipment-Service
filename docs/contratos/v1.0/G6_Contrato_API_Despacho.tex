...
\begin{tikzpicture}[
  ...
  \node[extbox, above=1.8cm of g5] (g1)  {G1 --- Frontend\\\relax{\tiny[React / Next.js]}};
...
\begin{tabularx}{\textwidth}{l X X l}
  ...
  R3 & Duplicación de envíos por reintentos de G5 sin \texttt{Idempotency-Key}. & Constraint \texttt{UNIQUE} en \texttt{order\_id} a nivel de base de datos y verificación del header. & Medio \\
