...
\subsection{Cotizar Envío (Tarifa Consolidada)}

\routeheader{post}{POST}{/api/v1/shipments/quotes}

\textbf{Descripción:} Calcula la tarifa consolidada de un conjunto de paquetes. Usado por \textbf{G4 (Checkout)} antes de confirmar la compra. No guarda en base de datos.
...
\begin{lstlisting}
{
  "city": "Santiago",
  "packages": [
    { "originCd": "NORTE", "weightKg": 2.0, "dimensionsCm": { "length": 40, "width": 30, "height": 20 } },
