...
\textbf{Descripción:} Endpoint inteligente que cotiza envíos. Acepta dos modos de operación debido a dependencias con G4.

\vspace{0.3cm}
\textbf{Modo 1: Oficial (Cálculo Volumétrico Real)}

Requiere que G4 consolide volumetría (G3) y destino (G1).
...
\vspace{0.3cm}
\textbf{Modo 2: Parche Temporal (Fallback 5\%)}

Si G4 no cuenta con dimensiones o ciudad, se acepta el monto total de la orden (int64). El endpoint cobrará un 5\% fijo.
\textit{Nota: Parche habilitado de forma temporal para destrabar la integración E4.}
...
\vspace{0.3cm}
\textbf{Response --- 200 OK (Ambos Modos):}
...
% ── SHIPMENT_CREATED ──────────────────────────────────────────────────────────
\subsection{SHIPMENT_CREATED}

Se emite cuando G5 crea exitosamente un nuevo despacho.

\contractheader{SHIPMENT_CREATED}
...
% ── SHIPMENT_IN_TRANSIT ────────────────────────────────────────────────────────
\subsection{SHIPMENT_IN_TRANSIT}

Se emite cuando el paquete sale a reparto.

\contractheader{SHIPMENT_IN_TRANSIT}
...
% ── SHIPMENT_DELIVERED ────────────────────────────────────────────────────────
\subsection{SHIPMENT_DELIVERED}

Se emite cuando el paquete es entregado exitosamente.

\contractheader{SHIPMENT_DELIVERED}
...
% ── SHIPMENT_FAILED ───────────────────────────────────────────────────────────
\subsection{SHIPMENT_FAILED}

Se emite cuando un intento de entrega falla.

\contractheader{SHIPMENT_FAILED}
...
% ── SHIPMENT_RETURNED ─────────────────────────────────────────────────────────
\subsection{SHIPMENT_RETURNED}

Se emite cuando un paquete entregado es devuelto.

\contractheader{SHIPMENT_RETURNED}
